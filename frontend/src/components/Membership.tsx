...
const Membership = () => {
  ...
  return (
    <div className=' bg-[#37383C] w-screen lg:pt-36 lg:pb-36'>
        <div className=''>
            ...
            <div className='w-[36rem] flex  items-center mx-auto justify-center ' >
                <div className='w-[32rem] h-[550px] flex flex-col mx-auto  rounded-xl bg-[#464646]'>
                ...
                <div className='w-[36rem] flex flex-col mx-auto h-[600px] rounded-xl bg-[#FF662D]' >
                ...
                <div className='w-[36rem] h-[600px] flex items-center mx-auto justify-center ' >
                <div className='w-[32rem] flex flex-col  mx-auto h-[550px] rounded-xl bg-[#464646]'>
