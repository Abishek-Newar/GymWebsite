    ...
    <div className=' px-36 py-20 bg-[#37383C]'>
        <div className='w-full'>
            <div className='pt-36 h-96 flex flex-col md:grid md:grid-cols-2 '>
                ...
                <p className='text-xl text-gray-300 font-semibold w-full md:w-[50rem]'>We offer a wide range of comprehensive fitness programs designed to cater to individuals of fitness levels. Our aim to help you achieve specific goals and maximize results</p>
            </div>
